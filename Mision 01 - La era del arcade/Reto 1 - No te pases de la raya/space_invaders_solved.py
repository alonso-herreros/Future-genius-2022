...
leftLimit = 0   # variable that stores the value of the x coordinate of the left pixel limit. It should be 0
rightLimit = background.get_width() - playerImage.get_width() # variable that stores the value of the x coordinate of the right pixel limit. It should be equal to (background image width - ship image width)
print(f"{leftLimit}, {rightLimit}");
